...
class OnboardingTests(unittest.TestCase):
    def test_hosted_orcid_dialog_explains_unconfigured_oauth(self):
        ...
        self.assertIn('id="connectionOrcid" autocomplete="off" placeholder="0000-0000-0000-0000" readonly', html)
        self.assertIn('id="orcidLinkValue" autocomplete="off"', html)
        self.assertIn('const orcidInput = $("#connectionOrcid");', script)
        self.assertIn('orcidInput.readOnly = false;', script)
